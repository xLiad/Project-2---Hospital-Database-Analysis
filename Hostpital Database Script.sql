...
CREATE TABLE Trained_In (
  ...
  CertificationDate DATETIME2(0) NOT NULL,
  CertificationExpires DATETIME2(0) NOT NULL,
  CONSTRAINT fk_Trained_In_Physician_EmployeeID FOREIGN KEY(Physician) REFERENCES Physician(EmployeeID),
  CONSTRAINT fk_Trained_In_or_procedure_Code FOREIGN KEY(Treatment) REFERENCES or_procedure(Code),
...
CREATE TABLE On_Call (
  ...
  BlockFloor INTEGER NOT NULL, 
  BlockCode INTEGER NOT NULL,
  OnCallStart DATETIME2(0) NOT NULL,
  OnCallEnd DATETIME2(0) NOT NULL,
...
CREATE TABLE Stay (
  ...
  StayStart DATETIME2(0) NOT NULL,
  StayEnd DATETIME2(0) NOT NULL,
...
CREATE TABLE Undergoes (
  Patient INTEGER NOT NULL,
  or_procedure INTEGER NOT NULL,
  Stay INTEGER NOT NULL,
  DateUndergoes DATETIME2(0) NOT NULL,
  Physician INTEGER NOT NULL,
  AssistingNurse INTEGER,
  PRIMARY KEY(Patient, or_procedure, Stay, DateUndergoes),
  CONSTRAINT fk_Undergoes_Patient_SSN FOREIGN KEY(Patient) REFERENCES Patient(SSN),
  CONSTRAINT fk_Undergoes_or_procedure_Code FOREIGN KEY(or_procedure) REFERENCES or_procedure(Code),
...
INSERT INTO or_procedure VALUES(1,'Reverse Rhinopodoplasty',1500.0);
INSERT INTO or_procedure VALUES(2,'Obtuse Pyloric Recombobulation',3750.0);
INSERT INTO or_procedure VALUES(3,'Folded Demiophtalmectomy',4500.0);
INSERT INTO or_procedure VALUES(4,'Complete Walletectomy',10000.0);
INSERT INTO or_procedure VALUES(5,'Obfuscated Dermogastrotomy',4899.0);
INSERT INTO or_procedure VALUES(6,'Reversible Pancreomyoplasty',5600.0);
INSERT INTO or_procedure VALUES(7,'Follicular Demiectomy',25.0);
